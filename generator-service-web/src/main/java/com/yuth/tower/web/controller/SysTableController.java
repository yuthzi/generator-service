...
public class SysTableController {
    ...
    @Autowired private SysTableService service;
    ...
    @ApiOperation("修改表信息")
    @PutMapping("/modify")
    public ResponseResult<Integer> modifySysTable(@RequestBody SysTableModel model)
            throws Exception {
    ...
    public ResponseResult<Integer> batAddOrModify(@RequestBody List<SysTableModel> models)
            throws Exception {
    ...
    public ResponseResult<Integer> removeSysTable(@PathVariable("id") String tableId)
            throws Exception {
    ...
    public ResponseResult<Integer> batchRemoveSysTable(@RequestBody List<String> tableIds)
            throws Exception {
    ...
    @PostMapping("/list")
    public ResponseResult<ReturnList<SysTableRsp>> querySysTableList(
            @RequestBody SysTableQuery model) {
    ...
    public ResponseResult<SysTableModel> querySingleSysTable(@PathVariable("id") String tableId)
            throws Exception {
